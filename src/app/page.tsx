  ...
  return (
    <div className="App">
      <div className="cabecalho">
        ...
        <h1>{isLogin ? 'Fazer login' : 'Olá!'}</h1>
        {isLogin && <span>Use sua Conta do Google</span>}
        {!isLogin && (
          <span>Para continuar, primeiro confirme sua identidade</span>
        )}
      </div>
      <form>
        <input
        ...
        >
          {isLogin ? 'E-mail ou telefone:' : 'Digite sua senha'}
        </label>
        {isLogin && (
        ...
        {isLogin && (
          <p>
            ...
            <a
              href=""
              className="saiba"
              aria-label="Saiba mais sobre como usar o Modo visitante"
            >
              Saiba mais
            </a>
          </p>
        ...
        {
          <div className="lang">
            <span aria-label="">Português (Brasil)</span>
            <span className="svg">
              {' '}
              <svg
